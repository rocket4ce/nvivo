defmodule Nvivo.Accounts.Users do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :created_chat_rooms, Nvivo.Chats.ChatRoom, foreign_key: :creator_id

    many_to_many :chat_rooms, Nvivo.Chats.ChatRoom,
      join_through: "chat_room_participants",
      join_keys: [user_id: :id, chat_room_id: :id]

    has_many :messages, Nvivo.Chats.Message, foreign_key: :user_id
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Nvivo.Repo)
  ...
  """
  def valid_password?(%Nvivo.Accounts.Users{hashed_password: hashed_password}, password)
