defmodule NvivoWeb.UsersAuth do
  use NvivoWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_nvivo_web_users_remember_me"
  ...
  def log_out_users(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      NvivoWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_users:
      ...
      defmodule NvivoWeb.PageLive do
        use NvivoWeb, :live_view

        on_mount {NvivoWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{NvivoWeb.UsersAuth, :ensure_authenticated}] do
