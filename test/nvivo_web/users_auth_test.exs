defmodule NvivoWeb.UsersAuthTest do
  use NvivoWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Nvivo.Accounts
  alias NvivoWeb.UsersAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, NvivoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_users/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      NvivoWeb.Endpoint.subscribe(live_socket_id)
